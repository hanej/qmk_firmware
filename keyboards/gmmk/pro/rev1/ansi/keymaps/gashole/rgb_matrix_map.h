 ...
 */
    ...
    enum led_location_map {
        ...
        LED_A, // 9, A, k12
        LED_Z, // 10, Z, k14
        LED_LALT, // 11, Alt_L, k90
        LED_F2, // 12, F2, k36
        LED_2, // 13, 2, k27
        LED_W, // 14, W, k20
        LED_S, // 15, S, k22
        LED_X, // 16, X, k24
        LED_LCMD, // 17, Cmd_L, k93
        LED_F3, // 18, F3, k31
        LED_3, // 19, 3, k37
        LED_E, // 20, E, k30
        LED_D, // 21, D, k32
        ...
        LED_L1, // 67, LED, l01
        LED_R1, // 68, LED, l11
        LED_DEL, // 69, Del, k97 -- Between F12 and rotary encoder
        LED_L2, // 70, LED, l02
        LED_R2, // 71, LED, l12
        LED_HOME, // 72, Home, k65 -- 1st from encoder
        LED_L3, // 73, LED, l03
        LED_R3, // 74, LED, l13
        LED_END, // 75, End, k15 -- 2nd from encoder
        LED_L4, // 76, LED, l04
        LED_R4, // 77, LED, l14
        LED_EQL, // 78, =, k66
        ...
        LED_L5, // 80, LED, l05
        LED_R5, // 81, LED, l15
        LED_PGDN, // 82, PgDn, k75 -- 4th from encoder
        LED_L6, // 83, LED, l06
        LED_R6, // 84, LED, l16
        LED_BSPC, // 85, Back Space, ka1
        LED_PGUP, // 86, PgUp, k25 -- 3rd from encoder
        LED_L7, // 87, LED, l07
        LED_R7, // 88, LED, l17
        LED_RBRC, // 89, ], k61
        LED_RSFT, // 90, Shift_R, k91
        LED_L8, // 91, LED, l08
        LED_R8, // 92, LED, l18
        LED_BSLS, // 93, \, ka2
        LED_UP, // 94, Up, k35
    ...
    const uint8_t LED_LIST_FUNCROW[] = { LED_F1, LED_F2, LED_F3, LED_F4, LED_F5, LED_F6, LED_F7, LED_F8, LED_F9, LED_F10, LED_F11, LED_F12, LED_DEL };

    const uint8_t LED_LIST_EXTFUNCROW[] = { LED_1, LED_2, LED_3, LED_4, LED_5, LED_6, LED_7, LED_8, LED_9, LED_0, LED_MINS };
    ...
    const uint8_t LED_LIST_SIDEROW[] = { LED_HOME, LED_END, LED_PGUP, LED_PGDN };

    const uint8_t LED_LIST_MOUSEBTN[] = { LED_Q, LED_E, LED_R };

    const uint8_t LED_LIST_MOUSEACCEL[] = { LED_Z, LED_X, LED_C };

    const uint8_t LED_LIST_RESET[] = { LED_BSPC };
